...
video.addEventListener("click", ()=>{
    socket.emit("chat",{room:globleRoom,msg:`<a href="https://whatsapp-clone-9hg3.onrender.com/option.html?room=${globleRoom}&usertype=t">join video call</a>`,sendBy:selfObjectId,time:Date(Date.now())});
    window.location.href=`https://whatsapp-clone-9hg3.onrender.com/option.html?room=${globleRoom}&usertype=c`
})
vice.addEventListener("click", ()=>{
    socket.emit("chat",{room:globleRoom,msg:`<a href="https://whatsapp-clone-9hg3.onrender.com/vice.html?room=${globleRoom}&usertype=t">join vice call</a>`,sendBy:selfObjectId,time:Date(Date.now())});
    window.location.href=`https://whatsapp-clone-9hg3.onrender.com/vice.html?room=${globleRoom}&usertype=c`
})
