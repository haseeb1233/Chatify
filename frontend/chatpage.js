...
vice.addEventListener("click", ()=>{
    socket.emit("chat",{room:globleRoom,msg:`<a href="http://127.0.0.1:5501/vice.html?room=${globleRoom}&usertype=t">join vice call</a>`,sendBy:selfObjectId,time:Date(Date.now())});
    window.location.href=`http://127.0.0.1:5501/vice.html?room=${globleRoom}&usertype=c`
})
